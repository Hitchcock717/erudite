<template>
    <div class="home">
        ...
        <div v-else class="main">
            <div class="header">两周搞定动植物百科大全</div>
            <img src="../static/icons/logo.svg" />
            <div class="start" @click="showLogin=true">现在开始</div>
        </div>
        <div class="info" @click="goGit">© 2019-2021 hitchcock717@GitHub<span>苏ICP备xxxxxxx号-x</span></div>
    </div>
</template>
...
export default {
  ...
  methods: {
    ...
    goGit () {
      window.location.href = 'https://github.com/Hitchcock717'
    }
  }
}
</script>
